...
/*declare
  ...
  l_blob   BLOB;
begin
  INSERT INTO textures (id, texture)
  VALUES (1, empty_blob())
  RETURN texture INTO l_blob;
  l_bfile := BFILENAME('IMAGES', 'test_image.jpg');
  ...
  ---Add cosmetics
  insert into cosmetics values(1, 'Bowl', 'Dishes', 100);
  insert into cosmetics values(2, 'Bow', 'Clothing', 150);

  ---Add food
  insert into food values(1, 'Carrot', 3);
  insert into food values(2, 'Fish', 9);
  ...
  ---TODO: blob
  ---Add user_photoes
  insert into user_photoes values();
  insert into user_photoes values();

  ---TODO: нужна таблица с текстурами (3 значение)
  ---Add animals
  insert into animals values(1, 'Cat');
  insert into animals values(2, 'Dog');
  insert into animals values(3, 'Panda');
  insert into animals values(4, 'Raccoon');
end;
*/