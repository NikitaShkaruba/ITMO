   ...
   0008                     332 	.ds 1
                            ...
                            383 ;	SRC/led.c:4: static unsigned char old_led = 0;   // "Видеопамять" линейки светодиодов
   2164 75 08 00            384 	mov	_old_led,#0x00
                            385 ;--------------------------------------------------------
                            386 ; Home
                            387 ;--------------------------------------------------------
                            388 	.area HOME    (CODE)
                            ...
                            401 ;------------------------------------------------------------
                            402 ;	SRC/led.c:13: void led( unsigned char n, unsigned char on )
                            403 ;	-----------------------------------------
                            404 ;	 function led
                            405 ;	-----------------------------------------
   2416                     406 _led:
                    ...
                    0000    413 	ar0 = 0x00
                    0001    414 	ar1 = 0x01
   2416 C0 0D               415 	push	_bp
   2418 85 81 0D            416 	mov	_bp,sp
                            417 ;	SRC/led.c:18: if( n > 7 ) return;
   241B E5 82               418 	mov	a,dpl
   241D FA                  419 	mov	r2,a
   241E 24 F8               420 	add	a,#0xff - 0x07
   2420 50 02               421 	jnc	00102$
   2422 80 32               422 	sjmp	00106$
   2424                     423 00102$:
                            424 ;	SRC/led.c:20: c = old_led;
   2424 AB 08               425 	mov	r3,_old_led
                            426 ;	SRC/led.c:22: mask <<= n;
   2426 8A F0               427 	mov	b,r2
   2428 05 F0               428 	inc	b
   242A 74 01               429 	mov	a,#0x01
   242C 80 02               430 	sjmp	00113$
   242E                     431 00111$:
   242E 25 E0               432 	add	a,acc
   2430                     433 00113$:
   2430 D5 F0 FB            434 	djnz	b,00111$
   2433 FA                  435 	mov	r2,a
                            436 ;	SRC/led.c:24: if( on )
   2434 A8 0D               437 	mov	r0,_bp
   2436 18                  438 	dec	r0
   2437 18                  439 	dec	r0
   2438 18                  440 	dec	r0
   2439 E6                  441 	mov	a,@r0
   243A 60 05               442 	jz	00104$
                            443 ;	SRC/led.c:25: c |= mask;
   243C EA                  444 	mov	a,r2
   243D 42 03               445 	orl	ar3,a
   243F 80 05               446 	sjmp	00105$
   2441                     447 00104$:
                            448 ;	SRC/led.c:27: c &= ~mask;         
   2441 EA                  449 	mov	a,r2
   2442 F4                  450 	cpl	a
   2443 FA                  451 	mov	r2,a
   2444 52 03               452 	anl	ar3,a
   2446                     453 00105$:
                            454 ;	SRC/led.c:29: write_max( SV, c );     
   2446 C0 03               455 	push	ar3
   2448 C0 03               456 	push	ar3
   244A 90 00 07            457 	mov	dptr,#0x0007
   244D 12 21 6D            458 	lcall	_write_max
   2450 15 81               459 	dec	sp
   2452 D0 03               460 	pop	ar3
                            461 ;	SRC/led.c:31: old_led = c;
   2454 8B 08               462 	mov	_old_led,r3
   2456                     463 00106$:
   2456 D0 0D               464 	pop	_bp
   2458 22                  465 	ret
                            466 ;------------------------------------------------------------
                            ...
                            470 ;------------------------------------------------------------
                            471 ;	SRC/led.c:42: void leds( unsigned char on )
                            472 ;	-----------------------------------------
                            473 ;	 function leds
                            474 ;	-----------------------------------------
   2459                     475 _leds:
   2459 AA 82               476 	mov	r2,dpl
                            477 ;	SRC/led.c:44: write_max( SV, on );     
   245B C0 02               478 	push	ar2
   245D C0 02               479 	push	ar2
   245F 90 00 07            480 	mov	dptr,#0x0007
   2462 12 21 6D            481 	lcall	_write_max
   2465 15 81               482 	dec	sp
   2467 D0 02               483 	pop	ar2
                            484 ;	SRC/led.c:46: old_led = on;
   2469 8A 08               485 	mov	_old_led,r2
   246B 22                  486 	ret
                            487 	.area CSEG    (CODE)
                            488 	.area CONST   (CODE)
                            489 	.area XINIT   (CODE)
