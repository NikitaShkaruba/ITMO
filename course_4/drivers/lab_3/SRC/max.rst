                              ...
                              4 ; This file was generated Wed Nov 08 13:56:48 2017
                              5 ;--------------------------------------------------------
                              6 	.module max
   ...
   0000                     326 	.ds 8
                            ...
                            396 ;------------------------------------------------------------
                            397 ;	SRC/max.c:15: void write_max( unsigned char xdata *regnum, unsigned char val )
                            398 ;	-----------------------------------------
   ...
   216D                     401 _write_max:
                    ...
                    0000    408 	ar0 = 0x00
                    0001    409 	ar1 = 0x01
   216D C0 0D               410 	push	_bp
   216F 85 81 0D            411 	mov	_bp,sp
                            412 ;	SRC/max.c:17: unsigned char oldDPP = DPP;
                            413 ;	SRC/max.c:19: DPP     = MAXBASE;
                            414 ;	SRC/max.c:20: *regnum = val;
   2172 AC 84               415 	mov	r4,_DPP
   2174 75 84 08            416 	mov	_DPP,#0x08
   2177 A8 0D               417 	mov	r0,_bp
   2179 18                  418 	dec	r0
   217A 18                  419 	dec	r0
   217B 18                  420 	dec	r0
   217C E6                  421 	mov	a,@r0
   217D F0                  422 	movx	@dptr,a
                            423 ;	SRC/max.c:21: DPP     = oldDPP;
   217E 8C 84               424 	mov	_DPP,r4
   2180 D0 0D               425 	pop	_bp
   2182 22                  426 	ret
                            427 ;------------------------------------------------------------
                            ...
                            433 ;------------------------------------------------------------
                            434 ;	SRC/max.c:33: unsigned char read_max( unsigned char xdata *regnum )
                            435 ;	-----------------------------------------
                            436 ;	 function read_max
                            437 ;	-----------------------------------------
   2183                     438 _read_max:
                            439 ;	SRC/max.c:35: unsigned char oldDPP=DPP;
                            440 ;	SRC/max.c:38: DPP = MAXBASE;
                            441 ;	SRC/max.c:39: val = *regnum;
   2183 AC 84               442 	mov	r4,_DPP
   2185 75 84 08            443 	mov	_DPP,#0x08
   2188 E0                  444 	movx	a,@dptr
   2189 FA                  445 	mov	r2,a
                            446 ;	SRC/max.c:40: DPP = oldDPP;
   218A 8C 84               447 	mov	_DPP,r4
                            448 ;	SRC/max.c:42: return val;
   218C 8A 82               449 	mov	dpl,r2
   218E 22                  450 	ret
                            451 	.area CSEG    (CODE)
                            452 	.area CONST   (CODE)
                            453 	.area XINIT   (CODE)
