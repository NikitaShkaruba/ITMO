   ...
   2201                     401 _write_max:
                    ...
                    0000    408 	ar0 = 0x00
                    0001    409 	ar1 = 0x01
   2201 C0 18               410 	push	_bp
   2203 85 81 18            411 	mov	_bp,sp
   2206 AA 82               412 	mov	r2,dpl
   2208 AB 83               413 	mov	r3,dph
                            414 ;	SRC/max.c:52: unsigned char oldDPP = DPP;
   220A AC 84               415 	mov	r4,_DPP
                            416 ;	SRC/max.c:53: EA=0;
   220C C2 AF               417 	clr	_EA
                            418 ;	SRC/max.c:55: DPP     = MAXBASE;
   220E 75 84 08            419 	mov	_DPP,#0x08
                            420 ;	SRC/max.c:56: *regnum = val;
   2211 8A 82               421 	mov	dpl,r2
   2213 8B 83               422 	mov	dph,r3
   2215 A8 18               423 	mov	r0,_bp
   2217 18                  424 	dec	r0
   2218 18                  425 	dec	r0
   2219 18                  426 	dec	r0
   221A E6                  427 	mov	a,@r0
   221B F0                  428 	movx	@dptr,a
                            429 ;	SRC/max.c:57: DPP     = oldDPP;
   221C 8C 84               430 	mov	_DPP,r4
                            431 ;	SRC/max.c:58: EA=1;
   221E D2 AF               432 	setb	_EA
   2220 D0 18               433 	pop	_bp
   2222 22                  434 	ret
                            435 ;------------------------------------------------------------
                            436 ;Allocation info for local variables in function 'read_max'
                            437 ;------------------------------------------------------------
                            438 ;regnum                    Allocated to registers r2 r3 
                            439 ;oldDPP                    Allocated to registers r4 
                            440 ;val                       Allocated to registers r2 
                            441 ;------------------------------------------------------------
                            442 ;	SRC/max.c:74: unsigned char read_max( unsigned char xdata *regnum )
                            443 ;	-----------------------------------------
                            444 ;	 function read_max
                            445 ;	-----------------------------------------
   2223                     446 _read_max:
   2223 AA 82               447 	mov	r2,dpl
   2225 AB 83               448 	mov	r3,dph
                            449 ;	SRC/max.c:76: unsigned char oldDPP=DPP;
   2227 AC 84               450 	mov	r4,_DPP
                            451 ;	SRC/max.c:79: EA=0;
   2229 C2 AF               452 	clr	_EA
                            453 ;	SRC/max.c:81: DPP = MAXBASE;
   222B 75 84 08            454 	mov	_DPP,#0x08
                            455 ;	SRC/max.c:82: val = *regnum;
   222E 8A 82               456 	mov	dpl,r2
   2230 8B 83               457 	mov	dph,r3
   2232 E0                  458 	movx	a,@dptr
   2233 FA                  459 	mov	r2,a
                            460 ;	SRC/max.c:83: DPP = oldDPP;
   2234 8C 84               461 	mov	_DPP,r4
                            462 ;	SRC/max.c:84: EA=1;
   2236 D2 AF               463 	setb	_EA
                            464 ;	SRC/max.c:85: return val;
   2238 8A 82               465 	mov	dpl,r2
   223A 22                  466 	ret
                            467 	.area CSEG    (CODE)
                            468 	.area CONST   (CODE)
                            469 	.area XINIT   (CODE)
