   ...
   21AB                     406 _led:
                    ...
                    0000    413 	ar0 = 0x00
                    0001    414 	ar1 = 0x01
   21AB C0 18               415 	push	_bp
   21AD 85 81 18            416 	mov	_bp,sp
                            417 ;	SRC/led.c:55: if( n > 7 ) return;
   21B0 E5 82               418 	mov	a,dpl
   21B2 FA                  419 	mov	r2,a
   21B3 24 F8               420 	add	a,#0xff - 0x07
   21B5 50 02               421 	jnc	00102$
   21B7 80 32               422 	sjmp	00106$
   21B9                     423 00102$:
                            424 ;	SRC/led.c:57: c = old_led;
   21B9 AB 08               425 	mov	r3,_old_led
                            426 ;	SRC/led.c:59: mask <<= n;
   21BB 8A F0               427 	mov	b,r2
   21BD 05 F0               428 	inc	b
   21BF 74 01               429 	mov	a,#0x01
   21C1 80 02               430 	sjmp	00113$
   21C3                     431 00111$:
   21C3 25 E0               432 	add	a,acc
   21C5                     433 00113$:
   21C5 D5 F0 FB            434 	djnz	b,00111$
   21C8 FA                  435 	mov	r2,a
                            436 ;	SRC/led.c:61: if( on )
   21C9 A8 18               437 	mov	r0,_bp
   21CB 18                  438 	dec	r0
   21CC 18                  439 	dec	r0
   21CD 18                  440 	dec	r0
   21CE E6                  441 	mov	a,@r0
   21CF 60 05               442 	jz	00104$
                            443 ;	SRC/led.c:62: c |= mask;
   21D1 EA                  444 	mov	a,r2
   21D2 42 03               445 	orl	ar3,a
   21D4 80 05               446 	sjmp	00105$
   21D6                     447 00104$:
                            448 ;	SRC/led.c:64: c &= ~mask;         
   21D6 EA                  449 	mov	a,r2
   21D7 F4                  450 	cpl	a
   21D8 FA                  451 	mov	r2,a
   21D9 52 03               452 	anl	ar3,a
   21DB                     453 00105$:
                            454 ;	SRC/led.c:66: write_max( SV, c );     
   21DB C0 03               455 	push	ar3
   21DD C0 03               456 	push	ar3
   21DF 90 00 07            457 	mov	dptr,#0x0007
   21E2 12 22 01            458 	lcall	_write_max
   21E5 15 81               459 	dec	sp
   21E7 D0 03               460 	pop	ar3
                            461 ;	SRC/led.c:68: old_led = c;
   21E9 8B 08               462 	mov	_old_led,r3
   21EB                     463 00106$:
   21EB D0 18               464 	pop	_bp
   21ED 22                  465 	ret
                            466 ;------------------------------------------------------------
                            ...
                            474 ;	-----------------------------------------
   21EE                     475 _leds:
   21EE AA 82               476 	mov	r2,dpl
                            477 ;	SRC/led.c:89: write_max( SV, on );     
   21F0 C0 02               478 	push	ar2
   21F2 C0 02               479 	push	ar2
   21F4 90 00 07            480 	mov	dptr,#0x0007
   21F7 12 22 01            481 	lcall	_write_max
   21FA 15 81               482 	dec	sp
   21FC D0 02               483 	pop	ar2
                            484 ;	SRC/led.c:91: old_led = on;
   21FE 8A 08               485 	mov	_old_led,r2
   2200 22                  486 	ret
                            487 	.area CSEG    (CODE)
                            488 	.area CONST   (CODE)
                            489 	.area XINIT   (CODE)
