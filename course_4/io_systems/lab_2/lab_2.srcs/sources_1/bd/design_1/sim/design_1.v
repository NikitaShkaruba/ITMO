...
module design_1
   (capturetrig0,
    ...
    reset_rtl);
  input capturetrig0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLOCK_RTL CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLOCK_RTL, CLK_DOMAIN design_1_clk_in1_0, FREQ_HZ 100000000, PHASE 0.000" *) input clock_rtl;
  output generateout0;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 gpio_rtl " *) output [15:0]gpio_rtl_tri_o;
  output pwm0;
  ...
  assign capturetrig0_0_1 = capturetrig0;
  assign clk_in1_0_1 = clock_rtl;
  assign generateout0 = axi_timer_0_generateout0;
