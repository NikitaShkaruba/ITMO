    ...
    public Controller() {
        ...
        view.statPanel.xSpinner.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                model.setCursor(new Point((Integer)( ((JSpinner)e.getSource()).getValue() ), model.getCursor().y));
                updateView();
            }
        });
        view.statPanel.ySpinner.addChangeListener(new ChangeListener() {
            @Override
            public void stateChanged(ChangeEvent e) {
                model.setCursor(new Point(model.getCursor().x, (Integer)( ((JSpinner)e.getSource()).getValue() )));
                updateView();
            }
        });
        view.statPanel.RSlider.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                while (it.hasNext()) {
                    final Point buf = new Point((Point)it.next());
